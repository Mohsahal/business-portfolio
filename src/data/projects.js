export const projects = [
  {
    ...
    imageHeight: "h-[614px]",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCG7MOZOeD-vawtefC8uhwQxDijQNWhsVF5V0pIowFwUJHIqzTdB_ibsM5pVO5iQiA0mqSBLKmcSuDnBcIK3tX2TzllVpNiWzsCJQP0PgqjawJEt-jKflxWSHt0xyCVlCsmfKwaK0T0pbgl3K-MwuTMjqzx4N2qDdzRv7bWcNutfoeKBVLNxd3nFFBUilo4vHJmEeH_MyZL4PSaJoSOwN6yCCyVGyfqbC6xsPqT45Vhr3DVDdHVUj6j=s2048",
  ...
  {
    id: "elearning-live-demo",
    title: "E-Learning Platform",
    category: "Live Demo",
    stack: "React/WebRTC",
    tags: ["Live Demo", "EdTech", "Video Streaming", "React"],
    colSpan: "md:col-span-5",
    imageHeight: "h-[500px]",
    offset: "md:mt-24",
    image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop",
    alt: "Live e-learning platform demo interface",
    shortDescription: "Interact with our scalable education technology platform. Features an interactive video player, course progress tracking, and simulated quizzes.",
    overview: "This live demonstration allows you to experience the student dashboard of our custom e-learning portals. Test the video latency, navigate through course modules, and try the automated grading system.",
    client: "Interactive Demo",
    duration: "Live",
    year: "2026",
    challenge: "Showcasing complex state management like video progress and quiz scores in a safe, interactive environment.",
    solution: "Built a sandboxed React application that perfectly mirrors our production EdTech UI, complete with mock video streams and interactive assessments.",
    technologies: ["React", "Video.js", "Tailwind CSS", "Redux Toolkit", "WebRTC (Simulated)"],
    results: [
      { metric: "100%", label: "Functional Flow" },
      { metric: "Mocked", label: "Video Streaming" },
      { metric: "Real-time", label: "Progress Tracking" },
      { metric: "Live", label: "Interactive Demo" }
    ],
    architecture: [
      "Custom video player wrapper with custom controls",
      "Local storage for persisting mock course progress",
      "Interactive assessment engine with immediate feedback"
    ],
    liveDemoUrl: "https://client-bbyk.onrender.com"
  },
  {
  ...
  },
  {
    ...
    colSpan: "md:col-span-12",
    imageHeight: "h-[500px]",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCq8iKqPN6rmJJ7aWAXPFE7J8dL46BcSAvEIHhx0Kwc_hr7-mzXK5Ag3vUCr0jeqwGmCiwN8CcDUPAuunIT-oA7JSxVCjBTRwA0rIsV81TZydS046hm6yLgYfNh5iAgog8UAuu4cVpIEWwnRj7bpg2m23vT5yqWoX4jE1PaFk6MtpDaO3ChQ7ZvgtV9F3kPFagCoDeNKZXWxoKam_l6e-GaLNqlCDIKfJKeMcK25wklNJnL2YIaG9R7=s2048",
