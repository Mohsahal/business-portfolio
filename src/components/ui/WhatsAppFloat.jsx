  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] group">
      ...
      <a
        ...
        className="relative bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-2xl transition-all duration-300 flex items-center justify-center"
